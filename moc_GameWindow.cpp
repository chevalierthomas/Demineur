...
QT_MOC_LITERAL(1, 11, 25), // "changeDifficultyRequested"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "GameWindow\0changeDifficultyRequested\0"
    ""
};
...
void GameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWindow::changeDifficultyRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWindow::changeDifficultyRequested()
{
